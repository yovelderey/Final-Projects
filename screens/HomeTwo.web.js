...
const HomeTwo = ({ route }) => {
  ...
  return (
    <ImageBackground
      source={require('../assets/Home_three2.png')}
    ...
    >
      <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
        ...
        <Text style={styles.txt}>באיזה מקום / אולם אירועים מתקיים האירוע</Text>
          ...
          <TextInput
            style={[styles.input, { width: screenWidth > 600 ? '70%' : '70%' }]}
            placeholder="שם מקום"
            value={eventLocation}
...
backgroundImage: {
  flex: 1,
  width: '100%',
  minHeight: '100vh', // מוסיף התאמה לדפדפן
  resizeMode: 'cover',
...
title: {
  ...
  textAlign: 'center',
  marginBottom: 60,
  alignSelf: 'center', // לוודא שהוא באמצע
},
...
box: {
  ...
  elevation: 5,
  width: '100%',
  maxWidth: 600,         // הגבלת רוחב למרכז
  alignSelf: 'center',   // ממרכז את התיבה
  marginBottom: 20,
  textAlign: 'center',
  alignItems: 'center',
  justifyContent: 'center',
