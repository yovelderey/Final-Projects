...
import { View, ActivityIndicator,Text,FlatList,Image, Dimensions,ImageBackground, TouchableOpacity,Modal,TextInput, ScrollView,StyleSheet,Animated } from 'react-native';
...
useEffect(() => {
  ...
  return (
    <ImageBackground
      ...
      source={require('../assets/back4web.png')}
...
>
  ...
  <Text style={styles.btnTextSmall3}>פותח על ידי יובל טכנולוגיות, כל הזכויות שמורות ©</Text>
      ...
      <TouchableOpacity 
        style={[styles.editInvitationButton, { width: screenWidth > 600 ? '20%' : '70%' }]} 
  ...
  <View style={styles.colorPickers2}>
    ...
    {[
      ...
      <View key={type} style={styles.colorPickers}>
        ...
        <TouchableOpacity
          style={[styles.viewGuestsButton, { width: screenWidth > 600 ? '20%' : '70%' }]}
...
eventImage: {
  ...
  container: { width: '100%', maxWidth: 480, alignItems: 'center' , justifyContent: 'center',textAlign: 'center' },
  ...
  invitationContainer: {
    ...
    /* רוחב ומסגרת */
    width: '90%',
    maxWidth: 480,          // נראה מצוין גם במסכים רחבים
    borderWidth: 3,
    borderColor: 'gray',

    /* 🆕 זה מה שמרכז את ה־View בעצמו בתוך המסך */
    alignSelf: 'center',
  },
  colorBox: {
    width: 30,
