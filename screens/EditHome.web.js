...
import { TouchableOpacity, Dimensions, Text, TextInput, ImageBackground, StyleSheet, ScrollView, View, Alert } from 'react-native';
...
const EditHome = (props) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {/* סוג אירוע */}
      <TouchableOpacity style={[styles.inputButton, { width: screenWidth > 600 ? '30%' : '70%' }]} onPress={() => setShowCategoryPicker(true)}>
      ...
      {/* תאריך האירוע */}
      <TouchableOpacity style={[styles.inputButton, { width: screenWidth > 600 ? '30%' : '70%' }]} onPress={() => setShowDatePicker(true)}>
      ...
      {showDatePicker && (
        ...
        {/* שעת האירוע */}
        <TextInput
        style={[styles.input2, { width: screenWidth > 600 ? '30%' : '70%' }]}
      ...
      {/* מיקום האירוע */}
      <TextInput
        style={[styles.input, { width: screenWidth > 600 ? '30%' : '70%' }]}
        value={eventLocation}
      ...
      {/* כפתור שמירת האירוע */}
      <TouchableOpacity onPress={handleCreateEvent} style={[styles.saveButton, { width: screenWidth > 600 ? '30%' : '70%' }]}>
