...
const Task = ({route,props}) => {
  ...
  const [tableData, setTableData] = useState([
    ...
    { id: 11, text: 'האם סגרתם הסעות לאורחים?', checked: false },
    { id: 12, text: 'האם סגרתם שמלת כלה?', checked: false },
    { id: 13, text: 'האם סגרתם חליפת חתן?', checked: false },
    { id: 14, text: 'האם סגרתם תכשיטים לכלה?', checked: false },
    { id: 15, text: 'האם סגרתם חופה?', checked: false },
    { id: 16, text: 'האם סגרתם בר שתייה?', checked: false },
    { id: 17, text: 'האם סגרתם תא צילום?', checked: false },
    { id: 18, text: 'האם סגרתם בלונים מעוצבים?', checked: false },
    { id: 19, text: 'האם סגרתם קונפטי לאירוע?', checked: false },
    { id: 20, text: 'האם סגרתם מופע זיקוקים?', checked: false },
    { id: 21, text: 'האם סגרתם מפל שוקולד?', checked: false },
    { id: 22, text: 'האם סגרתם שירותי ניקיון?', checked: false },
    { id: 23, text: 'האם סגרתם שירותי אבטחה?', checked: false },
    { id: 24, text: 'האם סגרתם רקדנים מקצועיים?', checked: false },
    { id: 25, text: 'האם סגרתם מתופפים ושופרות?', checked: false },
    { id: 26, text: 'האם סגרתם מאפרת מקצועית?', checked: false },
    { id: 27, text: 'האם סגרתם מעצב שיער?', checked: false },
    { id: 28, text: 'האם סגרתם פינת יצירה לילדים?', checked: false },
    { id: 29, text: 'האם סגרתם בר קפה?', checked: false },
    { id: 30, text: 'האם סגרתם שולחן קינוחים?', checked: false },
    { id: 31, text: 'האם סגרתם עמדת שייקים?', checked: false },
    { id: 32, text: 'האם סגרתם בר קוקטיילים?', checked: false },
    { id: 33, text: 'האם סגרתם קרפ צרפתי?', checked: false },
    { id: 34, text: 'האם סגרתם דוכן גלידה?', checked: false },
    { id: 35, text: 'האם סגרתם מופע קסמים?', checked: false },
    { id: 36, text: 'האם סגרתם עיצוב חופה?', checked: false },
    { id: 37, text: 'האם סגרתם צלם מגנטים?', checked: false },
    { id: 38, text: 'האם סגרתם שירותי חניה?', checked: false },
    { id: 39, text: 'האם סגרתם פינת טעימות?', checked: false },
    { id: 41, text: 'האם סגרתם מנהל אירוע?', checked: false },
    { id: 42, text: 'האם סגרתם עיצוב כניסה לאולם?', checked: false },
    { id: 43, text: 'האם סגרתם צלם סטילס?', checked: false },
    { id: 44, text: 'האם סגרתם תאורת במה?', checked: false },
    { id: 45, text: 'האם סגרתם מערכת הגברה?', checked: false },
    { id: 46, text: 'האם סגרתם מפיק אירועים?', checked: false },
    { id: 47, text: 'האם סגרתם להקת נגנים?', checked: false },
    { id: 48, text: 'האם סגרתם מופע אומנותי?', checked: false },
    { id: 49, text: 'האם סגרתם קריינות לאירוע?', checked: false },
    { id: 50, text: 'האם סגרתם מתנות לאורחים?', checked: false },
    { id: 51, text: 'האם סגרתם פינת צילום עם אביזרים?', checked: false },
    { id: 52, text: 'האם סגרתם פינת צילום 360?', checked: false },
    { id: 53, text: 'האם סגרתם עיצוב כיסאות?', checked: false },
    { id: 54, text: 'האם סגרתם שף פרטי?', checked: false },
    { id: 55, text: 'האם סגרתם מופע לייזרים?', checked: false },
    { id: 56, text: 'האם סגרתם רכב חתונה?', checked: false },
    { id: 57, text: 'האם סגרתם תפאורה לחינה?', checked: false },
    { id: 58, text: 'האם סגרתם תלבושות לחינה?', checked: false },
    { id: 59, text: 'האם סגרתם תכשיטים לחינה?', checked: false },
    { id: 62, text: 'האם סגרתם מאפרת לחינה?', checked: false },
    { id: 63, text: 'האם סגרתם צלם לחינה?', checked: false },
    { id: 64, text: 'האם סגרתם הזמנות דיגיטליות?', checked: false },
    { id: 65, text: 'האם סגרתם חבילת צילום לחתונה?', checked: false },
    { id: 66, text: 'האם סגרתם חבילת צילום לחינה?', checked: false },
    { id: 67, text: 'האם סגרתם אולם קטן לאירוע משפחתי?', checked: false },
    { id: 68, text: 'האם סגרתם הפקת חינה?', checked: false },
    { id: 69, text: 'האם סגרתם תפאורה לאירוע?', checked: false },
  ]);
      ...
      <View style={styles.noteItem}>
        ...
        <View style={styles.noteButtons}>
          ...
          <TouchableOpacity onPress={() => deleteNote(item.id)} style={styles.deleteButton}>
            <Text style={styles.deleteText}>🗑️ מחק</Text>
          </TouchableOpacity>
        </View>
      </View>
    )}
