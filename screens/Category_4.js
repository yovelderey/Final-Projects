...
function Category_4(props) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollViewContainer}>
              ...
              <Text style={[styles.title,{marginTop: 10}]}>Caegory_4</Text>

              <View style={styles.toolbar_bag}>
                       

              <TouchableOpacity onPress={handlePress} style={[styles.toolbar_down, { marginHorizontal: 0,marginTop:70 }]}>
